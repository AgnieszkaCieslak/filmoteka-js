let t;var e,r,n,o,i,s=globalThis;// const btnALL = document.querySelector('button_all');
...
all:document.querySelector(".output_all"),search:document.querySelector(".output_search"),details:document.querySelector(".output_details"),YT:document.querySelector(".output_YT"),outputAll:document.querySelector(".output-all")};function u(t,e){return function(){return t.apply(e,arguments)}}// utils is a library of generic helper functions non-specific to axios
const{toString:l}=Object.prototype,{getPrototypeOf:f}=Object,c=(e=Object.create(null),t=>{let r=l.call(t);return e[r]||(e[r]=r.slice(8,-1).toLowerCase())}),h=t=>(t=t.toLowerCase(),e=>c(e)===t),p=t=>e=>typeof e===t,{isArray:d}=Array,y=p("undefined"),g=h("ArrayBuffer"),m=p("string"),b=p("function"),E=p("number"),w=t=>null!==t&&"object"==typeof t,A=t=>{if("object"!==c(t))return!1;let e=f(t);return(null===e||e===Object.prototype||null===Object.getPrototypeOf(e))&&!(Symbol.toStringTag in t)&&!(Symbol.iterator in t)},v=h("Date"),O=h("File"),R=h("Blob"),S=h("FileList"),B=h("URLSearchParams");/**
...
let i=r?Object.getOwnPropertyNames(t):Object.keys(t),s=i.length;for(n=0;n<s;n++)o=i[n],e.call(null,t[o],o,t)}}}function U(t,e){let r;e=e.toLowerCase();let n=Object.keys(t),o=n.length;for(;o-- >0;)if(e===(r=n[o]).toLowerCase())return r;return null}const C=/*eslint no-undef:0*/"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:s,L=t=>!y(t)&&t!==C,_=(r="undefined"!=typeof Uint8Array&&f(Uint8Array),t=>r&&t instanceof r),I=h("HTMLFormElement"),j=(({hasOwnProperty:t})=>(e,r)=>t.call(e,r))(Object.prototype),N=h("RegExp"),x=(t,e)=>{let r=Object.getOwnPropertyDescriptors(t),n={};T(r,(r,o)=>{let i;!1!==(i=e(r,o,t))&&(n[o]=i||r)}),Object.defineProperties(t,n)},P="abcdefghijklmnopqrstuvwxyz",k="0123456789",F={DIGIT:k,ALPHA:P,ALPHA_DIGIT:P+P.toUpperCase()+k},D=h("AsyncFunction");var M={isArray:d,isArrayBuffer:g,isBuffer:/**
...
J["-".charCodeAt(0)]=62,J["_".charCodeAt(0)]=63,o=function(t,e,r,n,o){var i,s,a=8*o-n-1,u=(1<<a)-1,l=u>>1,f=-7,c=r?o-1:0,h=r?-1:1,p=t[e+c];for(c+=h,i=p&(1<<-f)-1,p>>=-f,f+=a;f>0;i=256*i+t[e+c],c+=h,f-=8);for(s=i&(1<<-f)-1,i>>=-f,f+=n;f>0;s=256*s+t[e+c],c+=h,f-=8);if(0===i)i=1-l;else{if(i===u)return s?NaN:(p?-1:1)*(1/0);s+=Math.pow(2,n),i-=l}return(p?-1:1)*s*Math.pow(2,i-n)},i=function(t,e,r,n,o,i){var s,a,u,l=8*i-o-1,f=(1<<l)-1,c=f>>1,h=23===o?5960464477539062e-23:0,p=n?0:i-1,d=n?1:-1,y=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(a=isNaN(e)?1:0,s=f):(s=Math.floor(Math.log(e)/Math.LN2),e*(u=Math.pow(2,-s))<1&&(s--,u*=2),s+c>=1?e+=h/u:e+=h*Math.pow(2,1-c),e*u>=2&&(s++,u/=2),s+c>=f?(a=0,s=f):s+c>=1?(a=(e*u-1)*Math.pow(2,o),s+=c):(a=e*Math.pow(2,c-1)*Math.pow(2,o),s=0));o>=8;t[r+p]=255&a,p+=d,a/=256,o-=8);for(s=s<<o|a,l+=o;l>0;t[r+p]=255&s,p+=d,s/=256,l-=8);t[r+p-d]|=128*y};const Y="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
let o=!1;for(;;)switch(e){case"ascii":case"latin1":case"binary":return r;case"utf8":case"utf-8":return tS(t).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*r;case"hex":return r>>>1;case"base64":return tB(t).length;default:if(o)return n?-1:tS(t).length// assume utf8
...
,"function"==typeof Uint8Array.prototype.indexOf)?o?Uint8Array.prototype.indexOf.call(t,e,r):Uint8Array.prototype.lastIndexOf.call(t,e,r):tl(t,[e],r,n,o);throw TypeError("val must be string, number or Buffer")}function tl(t,e,r,n,o){let i,s=1,a=t.length,u=e.length;if(void 0!==n&&("ucs2"===(n=String(n).toLowerCase())||"ucs-2"===n||"utf16le"===n||"utf-16le"===n)){if(t.length<2||e.length<2)return -1;s=2,a/=2,u/=2,r/=2}function l(t,e){return 1===s?t[e]:t.readUInt16BE(e*s)}if(o){let n=-1;for(i=r;i<a;i++)if(l(t,i)===l(e,-1===n?0:i-n)){if(-1===n&&(n=i),i-n+1===u)return n*s}else -1!==n&&(i-=i-n),n=-1}else for(r+u>a&&(r=a-u),i=r;i>=0;i--){let r=!0;for(let n=0;n<u;n++)if(l(t,i+n)!==l(e,n)){r=!1;break}if(r)return i}return -1}function tf(t,e,r){r=Math.min(t.length,r);let n=[],o=e;for(;o<r;){let e=t[o],i=null,s=e>239?4:e>223?3:e>191?2:1;if(o+s<=r){let r,n,a,u;switch(s){case 1:e<128&&(i=e);break;case 2:(192&(r=t[o+1]))==128&&(u=(31&e)<<6|63&r)>127&&(i=u);break;case 3:r=t[o+1],n=t[o+2],(192&r)==128&&(192&n)==128&&(u=(15&e)<<12|(63&r)<<6|63&n)>2047&&(u<55296||u>57343)&&(i=u);break;case 4:r=t[o+1],n=t[o+2],a=t[o+3],(192&r)==128&&(192&n)==128&&(192&a)==128&&(u=(15&e)<<18|(63&r)<<12|(63&n)<<6|63&a)>65535&&u<1114112&&(i=u)}}null===i?(// we did not generate a valid codePoint so insert a
...
delete this.name}get code(){return t}set code(t){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:t,writable:!0})}toString(){return`${this.name} [${t}]: ${this.message}`}}}function tw(t){let e="",r=t.length,n="-"===t[0]?1:0;for(;r>=n+4;r-=3)e=`_${t.slice(r-3,r)}${e}`;return`${t.slice(0,r)}${e}`}function tA(t,e,r,n,o,i){if(t>r||t<e){let n;let o="bigint"==typeof e?"n":"";throw n=i>3?0===e||e===BigInt(0)?`>= 0${o} and < 2${o} ** ${(i+1)*8}${o}`:`>= -(2${o} ** ${(i+1)*8-1}${o}) and < 2 ** ${(i+1)*8-1}${o}`:`>= ${e}${o} and <= ${r}${o}`,new tb.ERR_OUT_OF_RANGE("value",n,t)}tv(o,"offset"),(void 0===n[o]||void 0===n[o+i])&&tO(o,n.length-(i+1))}function tv(t,e){if("number"!=typeof t)throw new tb.ERR_INVALID_ARG_TYPE(e,"number",t)}function tO(t,e,r){if(Math.floor(t)!==t)throw tv(t,r),new tb.ERR_OUT_OF_RANGE(r||"offset","an integer",t);if(e<0)throw new tb.ERR_BUFFER_OUT_OF_BOUNDS;throw new tb.ERR_OUT_OF_RANGE(r||"offset",`>= ${r?1:0} and <= ${e}`,t)}tE("ERR_BUFFER_OUT_OF_BOUNDS",function(t){return t?`${t} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),tE("ERR_INVALID_ARG_TYPE",function(t,e){return`The "${t}" argument must be of type number. Received type ${typeof e}`},TypeError),tE("ERR_OUT_OF_RANGE",function(t,e,r){let n=`The value of "${t}" is out of range.`,o=r;return Number.isInteger(r)&&Math.abs(r)>4294967296?o=tw(String(r)):"bigint"==typeof r&&(o=String(r),(r>BigInt(2)**BigInt(32)||r<-(BigInt(2)**BigInt(32)))&&(o=tw(o)),o+="n"),n+=` It must be ${e}. Received ${o}`},RangeError);// HELPER FUNCTIONS
// ================
const tR=/[^+/0-9A-Za-z-_]/g;function tS(t,e){let r;e=e||1/0;let n=t.length,o=null,i=[];for(let s=0;s<n;++s){// is surrogate component
...
function tL(t){return"undefined"==typeof BigInt?t_:t}function t_(){throw Error("BigInt not supported")}/**
 * Determines if the given thing is a array or js object.
 *
 * @param {string} thing - The object or array to be visited.
 *
 * @returns {boolean}
 */function tI(t){return M.isPlainObject(t)||M.isArray(t)}/**
 * It removes the brackets from the end of a string
 *
 * @param {string} key - The key of the parameter.
 *
 * @returns {string} the key without the brackets.
 */function tj(t){return M.endsWith(t,"[]")?t.slice(0,-2):t}/**
...
t=tj(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}const tx=M.toFlatObject(M,{},null,function(t){return/^is[A-Z]/.test(t)});var tP=/**
...
return!M.isUndefined(e[t])});let n=r.metaTokens,o=r.visitor||f,i=r.dots,s=r.indexes,a=r.Blob||"undefined"!=typeof Blob&&Blob,u=a&&M.isSpecCompliantForm(e);if(!M.isFunction(o))throw TypeError("visitor must be a function");function l(t){if(null===t)return"";if(M.isDate(t))return t.toISOString();if(!u&&M.isBlob(t))throw new $("Blob is not supported. Use a Buffer instead.");return M.isArrayBuffer(t)||M.isTypedArray(t)?u&&"function"==typeof Blob?new Blob([t]):Q.from(t):t}/**
   * Default visitor.
   *
   * @param {*} value
   ...
   */function f(t,r,o){let a=t;if(t&&!o&&"object"==typeof t){if(M.endsWith(r,"{}"))// eslint-disable-next-line no-param-reassign
r=n?r:r.slice(0,-2),// eslint-disable-next-line no-param-reassign
t=JSON.stringify(t);else{var u;if(M.isArray(t)&&(u=t,M.isArray(u)&&!u.some(tI))||(M.isFileList(t)||M.endsWith(r,"[]"))&&(a=M.toArray(t)))return(// eslint-disable-next-line no-param-reassign
r=tj(r),a.forEach(function(t,n){M.isUndefined(t)||null===t||e.append(!0===s?tN([r],n,i):null===s?r:r+"[]",l(t))}),!1)}}return!!tI(t)||(e.append(tN(o,r,i),l(t)),!1)}let c=[],h=Object.assign(tx,{defaultVisitor:f,convertValue:l,isVisitable:tI});if(!M.isObject(t))throw TypeError("data must be an object");return!function t(r,n){if(!M.isUndefined(r)){if(-1!==c.indexOf(r))throw Error("Circular reference detected in "+n.join("."));c.push(r),M.forEach(r,function(r,i){let s=!(M.isUndefined(r)||null===r)&&o.call(e,r,M.isString(i)?i.trim():i,n,h);!0===s&&t(r,n?n.concat(i):[i])}),c.pop()}}(t),e};/**
 ...
 */function tM(t){return encodeURIComponent(t).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function t$(t,e,r){let n;/*eslint no-param-reassign:0*/if(!e)return t;let o=r&&r.encode||tM,i=r&&r.serialize;if(n=i?i(e,r):M.isURLSearchParams(e)?e.toString():new tF(e,r).toString(o)){let e=t.indexOf("#");-1!==e&&(t=t.slice(0,e)),t+=(-1===t.indexOf("?")?"?":"&")+n}return t}tD.append=function(t,e){this._pairs.push([t,e])},tD.toString=function(t){let e=t?function(e){return t.call(this,e,tk)}:tk;return this._pairs.map(function(t){return e(t[0])+"="+e(t[1])},"").join("&")};var tq=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(t){M.forEach(this.handlers,function(e){null!==e&&t(e)})}},tz={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},tH="undefined"!=typeof URLSearchParams?URLSearchParams:tF,tJ="undefined"!=typeof FormData?FormData:null,tV="undefined"!=typeof Blob?Blob:null;/**
 ...
 *
 * @returns {boolean}
 */const tW=("undefined"==typeof navigator||"ReactNative"!==(t=navigator.product)&&"NativeScript"!==t&&"NS"!==t)&&"undefined"!=typeof window&&"undefined"!=typeof document,tG="undefined"!=typeof WorkerGlobalScope&&// eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope&&"function"==typeof self.importScripts;var tK={classes:{URLSearchParams:tH,FormData:tJ,Blob:tV},isStandardBrowserEnv:tW,isStandardBrowserWebWorkerEnv:tG,protocols:["http","https","file","blob","url","data"]},tY=/**
 ...
 */function(t){let e,r;let n={},o=Object.keys(t),i=o.length;for(e=0;e<i;e++)n[r=o[e]]=t[r];return n}(n[i])),!s}(M.matchAll(/\w+|\[(\w*)]/g,t).map(t=>"[]"===t[0]?"":t[1]||t[0]),r,e,0)}),e}return null};const tX={transitional:tz,adapter:["xhr","http"],transformRequest:[function(t,e){let r;let n=e.getContentType()||"",o=n.indexOf("application/json")>-1,i=M.isObject(t);i&&M.isHTMLForm(t)&&(t=new FormData(t));let s=M.isFormData(t);if(s)return o&&o?JSON.stringify(tY(t)):t;if(M.isArrayBuffer(t)||M.isBuffer(t)||M.isStream(t)||M.isFile(t)||M.isBlob(t))return t;if(M.isArrayBufferView(t))return t.buffer;if(M.isURLSearchParams(t))return e.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),t.toString();if(i){if(n.indexOf("application/x-www-form-urlencoded")>-1){var a,u;return(a=t,u=this.formSerializer,tP(a,new tK.classes.URLSearchParams,Object.assign({visitor:function(t,e,r,n){return tK.isNode&&M.isBuffer(t)?(this.append(e,t.toString("base64")),!1):n.defaultVisitor.apply(this,arguments)}},u))).toString()}if((r=M.isFileList(t))||n.indexOf("multipart/form-data")>-1){let e=this.env&&this.env.FormData;return tP(r?{"files[]":t}:t,e&&new e,this.formSerializer)}}return i||o?(e.setContentType("application/json",!1),/**
 ...
 */tZ=t=>{let e,r,n;let o={};return t&&t.split("\n").forEach(function(t){n=t.indexOf(":"),e=t.substring(0,n).trim().toLowerCase(),r=t.substring(n+1).trim(),!e||o[e]&&tQ[e]||("set-cookie"===e?o[e]?o[e].push(r):o[e]=[r]:o[e]=o[e]?o[e]+", "+r:r)}),o};const t0=Symbol("internals");function t1(t){return t&&String(t).trim().toLowerCase()}function t2(t){return!1===t||null==t?t:M.isArray(t)?t.map(t2):String(t)}const t6=t=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(t.trim());function t5(t,e,r,n,o){if(M.isFunction(n))return n.call(this,e,r);if(o&&(e=r),M.isString(e)){if(M.isString(n))return -1!==e.indexOf(n);if(M.isRegExp(n))return n.test(e)}}class t8{constructor(t){t&&this.set(t)}set(t,e,r){let n=this;function o(t,e,r){let o=t1(e);if(!o)throw Error("header name must be a non-empty string");let i=M.findKey(n,o);i&&void 0!==n[i]&&!0!==r&&(void 0!==r||!1===n[i])||(n[i||e]=t2(t))}let i=(t,e)=>M.forEach(t,(t,r)=>o(t,r,e));return M.isPlainObject(t)||t instanceof this.constructor?i(t,e):M.isString(t)&&(t=t.trim())&&!t6(t)?i(tZ(t),e):null!=t&&o(e,t,r),this}get(t,e){if(t=t1(t)){let r=M.findKey(this,t);if(r){let t=this[r];if(!e)return t;if(!0===e)return function(t){let e;let r=Object.create(null),n=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;for(;e=n.exec(t);)r[e[1]]=e[2];return r}(t);if(M.isFunction(e))return e.call(this,t,r);if(M.isRegExp(e))return e.exec(t);throw TypeError("parser must be boolean|regexp|function")}}}has(t,e){if(t=t1(t)){let r=M.findKey(this,t);return!!(r&&void 0!==this[r]&&(!e||t5(this,this[r],r,e)))}return!1}delete(t,e){let r=this,n=!1;function o(t){if(t=t1(t)){let o=M.findKey(r,t);o&&(!e||t5(r,r[o],o,e))&&(delete r[o],n=!0)}}return M.isArray(t)?t.forEach(o):o(t),n}clear(t){let e=Object.keys(this),r=e.length,n=!1;for(;r--;){let o=e[r];(!t||t5(this,this[o],o,t,!0))&&(delete this[o],n=!0)}return n}normalize(t){let e=this,r={};return M.forEach(this,(n,o)=>{let i=M.findKey(r,o);if(i){e[i]=t2(n),delete e[o];return}let s=t?o.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(t,e,r)=>e.toUpperCase()+r):String(o).trim();s!==o&&delete e[o],e[s]=t2(n),r[s]=!0}),this}concat(...t){return this.constructor.concat(this,...t)}toJSON(t){let e=Object.create(null);return M.forEach(this,(r,n)=>{null!=r&&!1!==r&&(e[n]=t&&M.isArray(r)?r.join(", "):r)}),e}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([t,e])=>t+": "+e).join("\n")}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(t){return t instanceof this?t:new this(t)}static concat(t,...e){let r=new this(t);return e.forEach(t=>r.set(t)),r}static accessor(t){let e=this[t0]=this[t0]={accessors:{}},r=e.accessors,n=this.prototype;function o(t){let e=t1(t);r[e]||(!function(t,e){let r=M.toCamelCase(" "+e);["get","set","has"].forEach(n=>{Object.defineProperty(t,n+r,{value:function(t,r,o){return this[n].call(this,e,t,r,o)},configurable:!0})})}(n,t),r[e]=!0)}return M.isArray(t)?t.forEach(o):o(t),this}}function t4(t,e){let r=this||tX,n=e||r,o=t8.from(n.headers),i=n.data;return M.forEach(t,function(t){i=t.call(r,i,o.normalize(),e?e.status:void 0)}),o.normalize(),i}function t3(t){return!!(t&&t.__CANCEL__)}/**
 ...
 */function t7(t,e,r){$.call(this,null==t?"canceled":t,$.ERR_CANCELED,e,r),this.name="CanceledError"}t8.accessor(["Content-Type","Content-Length","Accept","Accept-Encoding","User-Agent","Authorization"]),M.reduceDescriptors(t8.prototype,({value:t},e)=>{let r=e[0].toUpperCase()+e.slice(1);// map `set` => `Set`
return{get:()=>t,set(t){this[r]=t}}}),M.freezeMethods(t8),M.inherits(t7,$,{__CANCEL__:!0});var t9=tK.isStandardBrowserEnv?{write:function(t,e,r,n,o,i){let s=[];s.push(t+"="+encodeURIComponent(e)),M.isNumber(r)&&s.push("expires="+new Date(r).toGMTString()),M.isString(n)&&s.push("path="+n),M.isString(o)&&s.push("domain="+o),!0===i&&s.push("secure"),document.cookie=s.join("; ")},read:function(t){let e=document.cookie.match(RegExp("(^|;\\s*)("+t+")=([^;]*)"));return e?decodeURIComponent(e[3]):null},remove:function(t){this.write(t,"",Date.now()-864e5)}}:{write:function(){},read:function(){return null},remove:function(){}};function et(t,e){return t&&!/^([a-z][a-z\d+\-.]*:)?\/\//i.test(e)?e?t.replace(/\/+$/,"")+"/"+e.replace(/^\/+/,""):t:e}var ee=tK.isStandardBrowserEnv?// whether the request URL is of the same origin as current location.
...
r.setAttribute("href",n),n=r.href),r.setAttribute("href",n),{href:r.href,protocol:r.protocol?r.protocol.replace(/:$/,""):"",host:r.host,search:r.search?r.search.replace(/^\?/,""):"",hash:r.hash?r.hash.replace(/^#/,""):"",hostname:r.hostname,port:r.port,pathname:"/"===r.pathname.charAt(0)?r.pathname:"/"+r.pathname}}/**
    ...
    */return t=n(window.location.href),function(e){let r=M.isString(e)?n(e):e;return r.protocol===t.protocol&&r.host===t.host}}():function(){return!0},er=/**
 * Calculate data maxRate
 * @param {Number} [samplesCount= 10]
 * @param {Number} [min= 1000]
 * @returns {Function}
 */function(t,e){let r;t=t||10;let n=Array(t),o=Array(t),i=0,s=0;return e=void 0!==e?e:1e3,function(a){let u=Date.now(),l=o[s];r||(r=u),n[i]=a,o[i]=u;let f=s,c=0;for(;f!==i;)c+=n[f++],f%=t;if((i=(i+1)%t)===s&&(s=(s+1)%t),u-r<e)return;let h=l&&u-l;return h?Math.round(1e3*c/h):void 0}};function en(t,e){let r=0,n=er(50,250);return o=>{let i=o.loaded,s=o.lengthComputable?o.total:void 0,a=i-r,u=n(a),l=i<=s;r=i;let f={loaded:i,total:s,progress:s?i/s:void 0,bytes:a,rate:u||void 0,estimated:u&&s&&l?(s-i)/u:void 0,event:o};f[e?"download":"upload"]=!0,t(f)}}const eo="undefined"!=typeof XMLHttpRequest;var ei=eo&&function(t){return new Promise(function(e,r){let n,o,i=t.data,s=t8.from(t.headers).normalize(),a=t.responseType;function u(){t.cancelToken&&t.cancelToken.unsubscribe(n),t.signal&&t.signal.removeEventListener("abort",n)}M.isFormData(i)&&(tK.isStandardBrowserEnv||tK.isStandardBrowserWebWorkerEnv?s.setContentType(!1):s.getContentType(/^\s*multipart\/form-data/)?M.isString(o=s.getContentType())&&s.setContentType(o.replace(/^\s*(multipart\/form-data);+/,"$1")):s.setContentType("multipart/form-data"));let l=new XMLHttpRequest;// HTTP basic authentication
if(t.auth){let e=t.auth.username||"",r=t.auth.password?unescape(encodeURIComponent(t.auth.password)):"";s.set("Authorization","Basic "+btoa(e+":"+r))}let f=et(t.baseURL,t.url);function c(){if(!l)return;// Prepare the response
let n=t8.from("getAllResponseHeaders"in l&&l.getAllResponseHeaders()),o=a&&"text"!==a&&"json"!==a?l.response:l.responseText,i={data:o,status:l.status,statusText:l.statusText,headers:n,config:t,request:l};!function(t,e,r){let n=r.config.validateStatus;!r.status||!n||n(r.status)?t(r):e(new $("Request failed with status code "+r.status,[$.ERR_BAD_REQUEST,$.ERR_BAD_RESPONSE][Math.floor(r.status/100)-4],r.config,r.request,r))}(function(t){e(t),u()},function(t){r(t),u()},i),// Clean up request
...
l=null},tK.isStandardBrowserEnv){// Add xsrf header
// regarding CVE-2023-45857 config.withCredentials condition was removed temporarily
let e=ee(f)&&t.xsrfCookieName&&t9.read(t.xsrfCookieName);e&&s.set(t.xsrfHeaderName,e)}// Remove Content-Type if data is undefined
void 0===i&&s.setContentType(null),"setRequestHeader"in l&&M.forEach(s.toJSON(),function(t,e){l.setRequestHeader(e,t)}),M.isUndefined(t.withCredentials)||(l.withCredentials=!!t.withCredentials),a&&"json"!==a&&(l.responseType=t.responseType),"function"==typeof t.onDownloadProgress&&l.addEventListener("progress",en(t.onDownloadProgress,!0)),"function"==typeof t.onUploadProgress&&l.upload&&l.upload.addEventListener("progress",en(t.onUploadProgress)),(t.cancelToken||t.signal)&&(// Handle cancellation
// eslint-disable-next-line func-names
n=e=>{l&&(r(!e||e.type?new t7(null,t,l):e),l.abort(),l=null)},t.cancelToken&&t.cancelToken.subscribe(n),t.signal&&(t.signal.aborted?n():t.signal.addEventListener("abort",n)));let h=function(t){let e=/^([-+\w]{1,25})(:?\/\/|:)/.exec(t);return e&&e[1]||""}(f);if(h&&-1===tK.protocols.indexOf(h)){r(new $("Unsupported protocol "+h+":",$.ERR_BAD_REQUEST,t));return}// Send the request
l.send(i||null)})};const es={http:null,xhr:ei};M.forEach(es,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
}Object.defineProperty(t,"adapterName",{value:e})}});const ea=t=>`- ${t}`,eu=t=>M.isFunction(t)||null===t||!1===t;var el={getAdapter:t=>{let e,r;t=M.isArray(t)?t:[t];let{length:n}=t,o={};for(let i=0;i<n;i++){let n;if(r=e=t[i],!eu(e)&&void 0===(r=es[(n=String(e)).toLowerCase()]))throw new $(`Unknown adapter '${n}'`);if(r)break;o[n||"#"+i]=r}if(!r){let t=Object.entries(o).map(([t,e])=>`adapter ${t} `+(!1===e?"is not supported by the environment":"is not available in the build"));throw new $("There is no suitable adapter to dispatch the request "+(n?t.length>1?"since :\n"+t.map(ea).join("\n"):" "+ea(t[0]):"as no adapter specified"),"ERR_NOT_SUPPORT")}return r},adapters:es};/**
 * Throws a `CanceledError` if cancellation has been requested.
 *
 * @param {Object} config The config that is to be used for the request
 *
 * @returns {void}
 */function ef(t){if(t.cancelToken&&t.cancelToken.throwIfRequested(),t.signal&&t.signal.aborted)throw new t7(null,t)}function ec(t){ef(t),t.headers=t8.from(t.headers),// Transform request data
t.data=t4.call(t,t.transformRequest),-1!==["post","put","patch"].indexOf(t.method)&&t.headers.setContentType("application/x-www-form-urlencoded",!1);let e=el.getAdapter(t.adapter||tX.adapter);return e(t).then(function(e){return ef(t),// Transform response data
e.data=t4.call(t,t.transformResponse,e),e.headers=t8.from(e.headers),e},function(e){return!t3(e)&&(ef(t),e&&e.response&&(e.response.data=t4.call(t,t.transformResponse,e.response),e.response.headers=t8.from(e.response.headers))),Promise.reject(e)})}const eh=t=>t instanceof t8?t.toJSON():t;function ep(t,e){// eslint-disable-next-line no-param-reassign
 ...
 *
 * @returns {function}
 */ey.transitional=function(t,e,r){function n(t,e){return"[Axios v"+ed+"] Transitional option '"+t+"'"+e+(r?". "+r:"")}// eslint-disable-next-line func-names
return(r,o,i)=>{if(!1===t)throw new $(n(o," has been removed"+(e?" in "+e:"")),$.ERR_DEPRECATED);return e&&!eg[o]&&(eg[o]=!0,// eslint-disable-next-line no-console
console.warn(n(o," has been deprecated since v"+e+" and will be removed in the near future"))),!t||t(r,o,i)}};var em={assertOptions:/**
 ...
 */class eE{constructor(t){this.defaults=t,this.interceptors={request:new tq,response:new tq}}/**
   ...
   */request(t,e){let r,n;"string"==typeof t?(e=e||{}).url=t:e=t||{},e=ep(this.defaults,e);let{transitional:o,paramsSerializer:i,headers:s}=e;void 0!==o&&em.assertOptions(o,{silentJSONParsing:eb.transitional(eb.boolean),forcedJSONParsing:eb.transitional(eb.boolean),clarifyTimeoutError:eb.transitional(eb.boolean)},!1),null!=i&&(M.isFunction(i)?e.paramsSerializer={serialize:i}:em.assertOptions(i,{encode:eb.function,serialize:eb.function},!0)),// Set config.method
e.method=(e.method||this.defaults.method||"get").toLowerCase();// Flatten headers
let a=s&&M.merge(s.common,s[e.method]);s&&M.forEach(["delete","get","head","post","put","patch","common"],t=>{delete s[t]}),e.headers=t8.concat(a,s);// filter out skipped interceptors
let u=[],l=!0;this.interceptors.request.forEach(function(t){("function"!=typeof t.runWhen||!1!==t.runWhen(e))&&(l=l&&t.synchronous,u.unshift(t.fulfilled,t.rejected))});let f=[];this.interceptors.response.forEach(function(t){f.push(t.fulfilled,t.rejected)});let c=0;if(!l){let t=[ec.bind(this),void 0];for(t.unshift.apply(t,u),t.push.apply(t,f),n=t.length,r=Promise.resolve(e);c<n;)r=r.then(t[c++],t[c++]);return r}n=u.length;let h=e;for(c=0;c<n;){let t=u[c++],e=u[c++];try{h=t(h)}catch(t){e.call(this,t);break}}try{r=ec.call(this,h)}catch(t){return Promise.reject(t)}for(c=0,n=f.length;c<n;)r=r.then(f[c++],f[c++]);return r}getUri(t){t=ep(this.defaults,t);let e=et(t.baseURL,t.url);return t$(e,t.params,t.paramsSerializer)}}M.forEach(["delete","get","head","options"],function(t){/*eslint func-names:0*/eE.prototype[t]=function(e,r){return this.request(ep(r||{},{method:t,url:e,data:(r||{}).data}))}}),M.forEach(["post","put","patch"],function(t){/*eslint func-names:0*/function e(e){return function(r,n,o){return this.request(ep(o||{},{method:t,headers:e?{"Content-Type":"multipart/form-data"}:{},url:r,data:n}))}}eE.prototype[t]=e(),eE.prototype[t+"Form"]=e(!0)});/**
...
let n=new Promise(t=>{r.subscribe(t),e=t}).then(t);return n.cancel=function(){r.unsubscribe(e)},n},t(function(t,n,o){r.reason||(r.reason=new t7(t,n,o),e(r.reason))})}/**
   * Throws a `CanceledError` if cancellation has been requested.
 ...
 */function t(e){let r=new eE(e),n=u(eE.prototype.request,r);return M.extend(n,eE.prototype,r,{allOwnKeys:!0}),M.extend(n,r,null,{allOwnKeys:!0}),// Factory for creating new instances
n.create=function(r){return t(ep(e,r))},n}(tX);// Expose Axios class to allow class inheritance
ev.Axios=eE,// Expose Cancel & CancelToken
ev.CanceledError=t7,ev.CancelToken=ew,ev.isCancel=t3,ev.VERSION=ed,ev.toFormData=tP,// Expose AxiosError class
...
ev.isAxiosError=function(t){return M.isObject(t)&&!0===t.isAxiosError},// Expose mergeConfig
ev.mergeConfig=ep,ev.AxiosHeaders=t8,ev.formToJSON=t=>tY(M.isHTMLForm(t)?new FormData(t):t),ev.getAdapter=el.getAdapter,ev.HttpStatusCode=eA,ev.default=ev;// This module is intended to unwrap Axios default export as named.
// Keep top-level export same with static properties
// so that it can keep same with es module or cjs
const{Axios:eO,AxiosError:eR,CanceledError:eS,isCancel:eB,CancelToken:eT,VERSION:eU,all:eC,Cancel:eL,isAxiosError:e_,spread:eI,toFormData:ej,AxiosHeaders:eN,HttpStatusCode:ex,formToJSON:eP,getAdapter:ek,mergeConfig:eF}=ev,eD="4e243d8288d1053ad482b1cbee56dc45",eM="https://api.themoviedb.org/3/",e$={//   all: 'trending/all/day?language=en-US',
...
youtube:"movie/",movie_id:["945729","507089","787781","790459"]},eq=eM+e$.all+"api_key="+eD,ez=eM+e$.search+"api_key="+eD,eH=eM+e$.details+e$.movie_id[0]+"?api_key="+eD,eJ=eM+e$.youtube+e$.movie_id[1]+"/videos?api_key="+eD;ev.defaults.baseURL=eM;const eV=e$.all+"api_key="+eD;async function eW(){let{data:t}=await ev.get(eV);return t}document.addEventListener("DOMContentLoaded",async()=>{let t=await eW();t.forEach(t=>{let e=document.createElement("h2");e.textContent=t.list_name,e.classList.add("movie-name");let r=document.createElement("ul");r.classList.add("movie-list"),//UUdodanie przycisku "see more"//
...
// });
category.books.forEach(t=>{let e=document.createElement("li");e.classList.add("book-item"),e.innerHTML=`
              <img class="book-item_image" src="${t.book_image}" alt="${t.title}" data-id="${t._id}">
              <h3 class="book-item_title">${t.title}</h3>
              <p class="book-item_author"> ${t.author}</p>
            `,r.appendChild(e)}),a.outputAll.appendChild(e),a.outputAll.appendChild(r),a.outputAll.appendChild(seeMoreButton)})});var eG={save:(t,e)=>{try{let r=JSON.stringify(e);localStorage.setItem(t,r)}catch(t){console.error("Set state error: ",t.message)}},load:t=>{try{let e=localStorage.getItem(t);return null===e?[]:JSON.parse(e)}catch(t){console.error("Get state error: ",t.message)}},remove:t=>{try{localStorage.removeItem(t)}catch(t){console.error("Remove state error: ",t.message)}}};a.buttonsDiv.addEventListener("click",t=>{t.stopPropagation(),console.log("Div click"),eG.save("123","abc")}),a.btnALL.addEventListener("click",t=>{t.stopPropagation(),console.log(eq),eG.save("allMovies",JSON.stringify(eq));let e=eG.load("allMovies");a.all.innerHTML=`<a href=${e} class="link" target="_blank" crossorigin="anonymous"  rel="noopener noreferrer">the most popular movies Today</a>`}),a.btnSearch.addEventListener("click",t=>{console.log(ez),t.stopPropagation(),eG.save("search",ez);let e=eG.load("search");a.search.innerHTML=`<a href=${e} class="link" target="_blank" crossorigin="anonymous"  rel="noopener noreferrer">search movies</a>`}),a.btnDetails.addEventListener("click",t=>{console.log(eH),t.stopPropagation(),eG.save("details",eH);let e=eG.load("details");a.details.innerHTML=`<a href=${e} class="link" target="_blank" crossorigin="anonymous"  rel="noopener noreferrer">full info about movie</a>`}),a.btnYt.addEventListener("click",t=>{console.log(eJ),t.stopPropagation(),eG.save("youTube",eJ);let e=eG.load("youTube");a.YT.innerHTML=`<a href=${e} class="link" target="_blank" crossorigin="anonymous"  rel="noopener noreferrer">youTube trailer</a>`}),a.outputAll.innerHTML=`<p>tutaj ma sie pokazac plakat filmu</p>
...
<p>tutaj ma byc jego \u{15B}rednia popularnosc</p>`;//# sourceMappingURL=index.5ce7670b.js.map

//# sourceMappingURL=index.5ce7670b.js.map
